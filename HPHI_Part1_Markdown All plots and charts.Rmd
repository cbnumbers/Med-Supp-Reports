...
```{r Summary Tables (Formatted), echo=FALSE, include=FALSE}
...
```{r Claims and Premiums by Gender and Product, echo=FALSE, message = FALSE}
...
#####Green indicates Premium Amounts
#####Red indicates Claims Amounts
...
#### LR By Gender
```{r Table LR By Gender Chart, echo=FALSE, results='asis', error=FALSE, warning=FALSE}
...
***
#### LR By Top Agent
```{r Table LR By Top Agent Chart, echo=FALSE, results='asis', error=FALSE, warning=FALSE}


##creates custom CSS file in directory for color formatting etc.
writeLines("td, th { padding : 6px } th { background-color : grey ; color : white; border : 1px solid white; } td { color : black ; border : 1px solid grey }", con = "mystyle.css")

kable(LR_By_Top_Agent, format = "html")
```
...
#### LR By Issue Year
```{r Table LR By Issue Year Chart, echo=FALSE, results='asis', error=FALSE, warning=FALSE}


##creates custom CSS file in directory for color formatting etc.
writeLines("td, th { padding : 6px } th { background-color : grey ; color : white; border : 1px solid white; } td { color : black ; border : 1px solid grey }", con = "mystyle.css")

kable(LR_By_Issue_Year, format = "html")
```
***
***
